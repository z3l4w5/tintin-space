...
- `node modules`, package.json, package-lock.json, and package.hugo.json files—Associates and integrates Hugo with the JavaScript ecosystem. We will discuss using JavaScript with Hugo in detail in chapter 10.
