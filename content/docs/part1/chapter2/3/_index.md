...
Hugo standardizes some previously specified parts (like menu and title) in the configuration file. We will cover those parts in chapter 4. Other parts (like params) are differ- ent for each theme. Even image locations like that of the logo.svg are theme-specific.
